...
$enable_section = get_theme_mod( 'fotografie_hero_content_visibility', 'homepage' );
...
$id = get_theme_mod( 'fotografie_hero_content' );
					...
					<?php endif; ?>
						...
						<div class="entry-content">
							<?php
								...
								wp_link_pages( array(
									'before'      => '<div class="page-links"><span class="page-links-title">' . __( 'Pages:', 'fotografie' ) . '</span>',
									'after'       => '</div>',
									'link_before' => '<span class="page-number">',
									'link_after'  => '</span>',
									'pagelink'    => '<span class="screen-reader-text">' . __( 'Page', 'fotografie' ) . ' </span>%',
